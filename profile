# 👋 Hello, I'm Mahesh Gurung – student, learner and aspiring Full Stack Developer & Ex-Army Professional 🚀

![Banner](https://media.giphy.com/media/3o6nV4fA4I4vCq0mxe/giphy.gif)

I am a **Full Stack Developer** with a unique background as a **former Army professional**. After transitioning into tech, I developed strong skills in **backend** and **frontend development**. From **HTML/CSS** to **JavaScript**, **Python**, **C**, and **GoLang**, I build efficient, scalable applications that solve real-world problems.
